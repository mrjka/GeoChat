...
import com.example.jaldeep.geochat.AllChatsTab1;
...
public class TabsFragmentPageAdapter extends FragmentStatePagerAdapter   {
    ...
    public TabsFragmentPageAdapter(FragmentManager fm, CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        if(position == 0) {
            return new AllChatsTab1();
        } else if (position == 1)   {
            return new AllChatsTab2();
        }
        return null;
    }
